 ...
 */
final class Version20230224143418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponses CHANGE reponses reponse VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponses CHANGE reponse reponses VARCHAR(255) NOT NULL');
    }
}
